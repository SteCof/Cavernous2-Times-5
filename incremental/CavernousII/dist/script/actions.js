...
function mineManaRockCost(location, clone = null, realm = null, completionOveride) {
    return location.completions && !completionOveride
        ? 0
        : Math.pow(1 + (0.1 + 0.05 * (location.zone.index + (realm == null ? currentRealm : realm))) * longZoneCompletionMult(location.x, location.y, location.zone.index), completionOveride ?? (location.priorCompletions*5));
}
