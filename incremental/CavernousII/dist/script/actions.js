...
function completeMinePlume(loc, clone, action) {
    setMined(loc.x, loc.y);
...
function completeObsidianMine(loc) {
    getStuff("Obsidian").update(getDuplicationAmount(loc));
    setMined(loc.x, loc.y);
}
...
let combatTools = [
    ...
    [getStuff("Runestone"), 0.01, getStat("Runic Lore")],
    [getStuff("Crystal Ball"), 0.01, getStat("Magic")],
];
...
(function (ACTION) {
    ...
    ACTION["MINE_OBSIDIAN"] = "Mine Obsidian";
    ...
    ACTION["CREATE_RUNESTONE"] = "Create Runestone"
    ACTION["CREATE_CRYSTAL_BALL"] = "Create Crystal Ball"
    ACTION["MINE_BASALT_PLUME"] = "Mine Basalt Plume"
})(ACTION || (ACTION = {}));
const actions = [
    ...
    new Action("Mine Basalt Plume", getChopTime(4000000, 1), [["Mining", 1], ["Speed", 0.2]], completeMinePlume, null, isPainful),
    ...
    new Action("Mine Obsidian", 500000, [["Mining", 1]], completeObsidianMine, null, isVeryPainful),
    ...
    new Action("Complete Goal2", 100000, [["Gemcraft", 1]], completeGoal2, simpleRequire([["Gem", 20]])),
    ...
    new Action("Create Runestone", 600000, [["Smithing", 0.5], ["Gemcraft", 0.5]], simpleCreate([["Runestone", 1]]), simpleRequire([["Gem", 1], ["Obsidian", 1], ["Gold", 1]])),
    new Action("Create Crystal Ball", 600000, [["Smithing", 0.5], ["Gemcraft", 0.5]], simpleCreate([["Crystal Ball", 1]]), simpleRequire([["Gem", 2], ["Obsidian", 1]])),
