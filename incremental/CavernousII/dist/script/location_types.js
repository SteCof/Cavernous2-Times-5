...
const locationTypes = [
    ...
    new LocationType("Furnace", "╬", "A large box full of fire, hot enough to melt iron ore.", "Walk", "Make Iron Bars", null),
    ...
    new LocationType("Sacrificial Altar", "†", "Any clone that activates this will die, but mark their kin with blood.", "Walk", "Sacrifice", null),
