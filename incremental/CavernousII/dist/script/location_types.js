...
const locationTypes = [
    ...
    new LocationType("Basalt Plume", "¶", "{'2': 'The Verdant nature of this realm is getting metaphorical:'} This basalt seems to be growing out of a volcanic vent (Growth: 3000+1t)", "Mine Basalt Plume", null, null),
    ...
    new LocationType("Scriptorium", "ᛝ", "A collection of scrolls that can be bound into a magical book with {'0':2', '1':4} gems and {'0':1, '1':2} gold.", "Walk", "Create Tome", null),
