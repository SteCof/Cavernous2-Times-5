...
const messages = [
    ...
    new Message("Entering the Expansion", `
			At this point, the game becomes significantly less precisely balanced. In the core version of Cavernous II that means more grinding - in this version instead there will tend to be less precision required to complete tasks - with a lot of options of how to move forward at any given time.
			
			Reaching this point is a significant achievement, but I hope you'll enjoy my additions to Nucaranlaeg's excellent game in the Avernous Expansion. If you haven't already, find the Goal on zone 6, and start exploring this zone to see the changes.`),
